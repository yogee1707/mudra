...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body role="document">
    ...
    <div align="center" class="page-header">
      <img class="myMainIcon" src="img/sendMoney.png"></img>
      <h2 id="title">Send Money</h2>
    </div>
    ...
    <?php
          ...
          if($status == 'failed'){
            ...
            echo "<span class='glyphicon glyphicon-exclamation-sign' aria-hidden='true'></span>";
            echo "<span class='sr-only'>Error:</span>";
            echo " You're Administrator. Please <a href='adminLoginPage.php?status=attempt'>login here.</a>";
            echo "</div>";
          }
    ?>
    ...
    <div align="center" class="row">
      ...
      <div class="col-sm-8">
        ...
        <form action="spend.php" method="post" role="form">
          <div class="form-group">
            <label for="name">Enter your account number:</label>
            <input type="text" class="form-control" name="uid" placeholder="your account number" required>
          </div>
          <div class="form-group">
            <label for="name">Enter account number of benificiary:</label>
            <input type="text" class="form-control" name="receiverUid"  placeholder="benificiary's account number" required>
          </div>
          <div class="form-group">
            <label for="pwd">Enter your PIN:</label>
            <input type="password" class="form-control" name="pin"  placeholder="pin code" required>
          </div>
          <div class="form-group">
            <label for="pwd">Enter amount to send:</label>
